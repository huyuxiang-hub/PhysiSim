// g4-cls-copy : /usr/local/opticks_externals/g4_1042.build/geant4.10.04.p02/source/processes/electromagnetic/xrays/include/G4Cerenkov.hh
//
// ********************************************************************
...
//
//
// $Id: LocalG4Cerenkov1042.hh 108508 2018-02-15 15:54:35Z gcosmo $
//
// 
////////////////////////////////////////////////////////////////////////
...
#ifndef LocalG4Cerenkov1042_h
#define LocalG4Cerenkov1042_h 1
...
class LocalG4Cerenkov1042 : public G4VProcess
{
...
public:
  ...
  explicit LocalG4Cerenkov1042(G4int opticksMode = 0, const G4String& processName = "Cerenkov", 
             G4ProcessType type = fElectromagnetic);
  ~LocalG4Cerenkov1042();

  explicit LocalG4Cerenkov1042(const LocalG4Cerenkov1042 &right);
...
private:
  ...
  LocalG4Cerenkov1042& operator=(const LocalG4Cerenkov1042 &right) = delete;
...
inline
G4bool LocalG4Cerenkov1042::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline
G4double LocalG4Cerenkov1042::GetMaxBetaChangePerStep() const
{
  return fMaxBetaChange;
}

inline
G4int LocalG4Cerenkov1042::GetMaxNumPhotonsPerStep() const
{
  return fMaxPhotons;
}

inline
void LocalG4Cerenkov1042::SetStackPhotons(const G4bool stackingFlag)
{
        fStackingFlag = stackingFlag;
}

inline
G4bool LocalG4Cerenkov1042::GetStackPhotons() const
{
        return fStackingFlag;
}

inline
G4int LocalG4Cerenkov1042::GetNumPhotons() const
{
        return fNumPhotons;
}

inline
G4PhysicsTable* LocalG4Cerenkov1042::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* LocalG4Cerenkov1042_h */
// g4-cls-copy : /usr/local/opticks_externals/g4_1042.build/geant4.10.04.p02/source/processes/electromagnetic/xrays/include/G4Cerenkov.hh

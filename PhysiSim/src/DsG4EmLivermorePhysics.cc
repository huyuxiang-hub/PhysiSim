...
// ********************************************************************
//
// $Id: DsG4EmLivermorePhysics.cc 107183 2017-11-03 14:57:23Z gcosmo $
...
DECLARE_TOOL(DsG4EmLivermorePhysics);
G4_DECLARE_PHYSCONSTR_FACTORY(DsG4EmLivermorePhysics);
...
,ToolBase(name)
{
  ...
  declProp("UsePositronium", m_positronium_flag=true); 
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

DsG4EmLivermorePhysics::~DsG4EmLivermorePhysics()
{}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void DsG4EmLivermorePhysics::ConstructParticle()
{
  // gamma
  G4Gamma::Gamma();
...
void DsG4EmLivermorePhysics::ConstructProcess()
{
  if(verbose > 1) {
  ...
  for(const auto& particleName : partList.PartNames()) {
    ...
    if (particleName == "gamma") {
      ...
      ph->RegisterProcess(eIoni, particle);
      ph->RegisterProcess(eBrem, particle);
      if( !m_positronium_flag){
          ph->RegisterProcess(new G4eplusAnnihilation(), particle);
      } else{
      ph->RegisterProcess(new G4PositroniumFormation(), particle);}

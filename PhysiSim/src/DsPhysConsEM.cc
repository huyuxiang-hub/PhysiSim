...
{
    m_fluorCut=250*eV;
    // disable positronium by default
    declProp("UsePositronium", m_positronium_flag=false); 
}
...
{
    G4cout << "DsPhysConsEM::ConstructParticle()" << G4endl;
    ...
    while((*theParticleIterator)()) {
        ...
        if(particleName =="gamma") {  
            ...
            if (!m_positronium_flag) {
                ...
                G4cout << "For e+, positronium is used. " << G4endl;
                pmanager->AddProcess(new G4PositroniumFormation(),0,-1, 4);//it includes the possibility of annihilation
            }
        }	
